...
uint256 hashGenesisBlock("0xd4323a2bb262734b44e624ee7bb7cc5ab4d53f5adfea97fd0ff550f50077addf");
...
const string strMessageMagic = "MediCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 12 * 60 * 60; // MediCoin: 12 hour retarget
static const int64 nTargetSpacing = 120; // MediCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal medicoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MediCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x5a5fe357de4c9c06d6a3f3f911085f32762a8605265a1f4d9a0d37a0a2143f74");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Medicare News Today 01/09/2014 FDA approves new drug for treatment of type 2 diabetes";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1389383410; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1360320;

        if (fTestNet)
        {
            block.nTime    = 1389297005;
            block.nNonce   = 243918;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xfa6a91ef56bf35787c700eaf4bcecd7dbc3eae69ee5127aa5f6c0369770c3bab"));
